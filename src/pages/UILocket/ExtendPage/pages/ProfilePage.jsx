...
import { ChevronRight, Link as LucideLink, Settings } from "lucide-react";import { useApp } from "../../../../context/AppContext";
        ...
        >
          ...
          >
            <div className="flex flex-col text-center items-start space-y-1">
              ...
              >
                @{user?.username} <LucideLink className="ml-2" size={18} />
              </a>
            </div>
