  ...
  return (
    <>
      <p>
        ...
        nhanh hơn trên app. Khi đăng ảnh/video trên web thành công thì chuỗi sẽ
        nhảy lên 1 số là chuỗi sẽ được giữ.
      </p>

      <p>
        Về phần hiển thị chuỗi ví dụ trên web hiển thị là 5 mà trên app không có{" "}
        {"=>"} app bị lỗi, chỉ cần đăng một ảnh/video trên app Locket thì chuỗi
